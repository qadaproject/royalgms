...
const navItems = [
  { path: "/", label: "Dashboard", icon: LayoutDashboard, roles: ["admin", "chairman", "data_manager", "dispatch_unit", "protocol_liaison"] },
  { path: "/guests", label: "Guest Registry", icon: Users, roles: ["admin", "chairman", "data_manager"] },
    ...
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-sidebar flex flex-col z-50">
      ...
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          <RoyalCrest size="sm" />
          <div>
            <h1 className="font-heading text-lg font-semibold text-sidebar-primary tracking-wide">
              Royal RSVP
            </h1>
