...
export default function InviteDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#1a0a06] text-[#f5ede0] print-root">
      <style>{`
        @media print {
          ...
          .print-root { min-height: unset !important; }
          header { padding: 8px 16px 8px !important; }
          main { padding-top: 8px !important; padding-bottom: 8px !important; }
          main > * { margin-bottom: 6px !important; }
          .print-card { padding: 12px 16px !important; }
          .print-qr img { width: 80px !important; height: 80px !important; }
          p, span { line-height: 1.3 !important; }
        }
      `}</style>
